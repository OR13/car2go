...
const MeshPointManagerContract = contract(MeshPointManager)
MeshPointManagerContract.setProvider(provider)
...
export const MeshPointManagerContractGetFaucetByCreator = (fromAddress, _callback) => {
  MeshPointManagerContract.deployed()
  .then((_instance) => {
...
export const MeshPointManagerContractGetFaucetByName = (_name, _callback) => {
  MeshPointManagerContract.deployed()
  .then((_instance) => {
...
export const MeshPointManagerContractGetAllFaucetObjects = (_callback) => {
  MeshPointManagerContract.deployed()
  .then((_instance) => {
...
export const MeshPointManagerContractGetAllFaucetAddresses = (_callback) => {
  MeshPointManagerContract.deployed()
  .then((_instance) => {
    _instance.getFaucets
    .call()
...
export const MeshPointManagerContractCreateFaucet = (_name, fromAddress, _callback) => {
  MeshPointManagerContract.deployed()
  .then((_instance) => {
    _instance
...
export const MeshPointManagerContractRequestFaucetAccess = (_faucetAddress, _requestorAddress, _fromAddress, _callback) => {
  MeshPointManagerContract.deployed()
  .then((_instance) => {
    _instance
...
export const MeshPointManagerContractAuthorizeFaucetAccess = (_faucetAddress, _requestorAddress, _fromAddress, _callback) => {
  MeshPointManagerContract.deployed()
  .then((_instance) => {
    _instance
...
export const MeshPointManagerContractRevokeFaucetAccess = (_faucetAddress, _requestorAddress, _fromAddress, _callback) => {
  MeshPointManagerContract.deployed()
  .then((_instance) => {
    _instance
